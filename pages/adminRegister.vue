<template>
  <div class="flex flex-col items-center justify-center min-h-screen">
    <div class="bg-dark-blue/90 rounded-lg w-[600px] h-[700px] flex flex-col items-center justify-center">
      <div class="flex flex-col items-center justify-center mb-6">
        <p class="text-6xl text-green font-bold mb-2">CMS</p>
        <p class="text-xl text-white font-bold">ADMIN REGISTER</p>
      </div>
      <div>
        <form class="flex flex-col items-center justify-center" @submit.prevent="handleSubmit">
          ...
          <VTextField v-model="firstName" type="text" placeholder="first name" class="w-80 h-12 text-black m-2" />
          <VTextField v-model="lastName" type="text" placeholder="last name" class="w-80 h-12 text-black m-2" />
          <VTextField v-model="email" type="email" placeholder="email" class="w-80 h-12 text-black m-2" />
          <VTextField v-model="password" type="password" placeholder="password" class="w-80 h-12 text-black m-2" />
          <VTextField v-model="confirmPassword" type="password" placeholder="confirm password" class="w-80 h-12 text-black m-2" />
          <VButton
            class="w-28 mt-6"
            :is-bold="true"
            :is-rounded="true"
